...
#
# Rewrite your program in Problem 2.  This time in the functions  choose_room and  choose_meal, you must have two
# return statements in each function.
#
...
def main():
    ...
    room, room_cost = choose_room()
    print()
    meal, meal_cost = choose_meal()
    total_cost = room_cost + meal_cost
    print("\nSEMESTER COST FOR HOUSING AND MEALS\n")
    print("Housing:\t$" + format(room_cost, ',.2f') + " ", room)
    print("Meals:\t\t$" + format(meal_cost, ',.2f') + " ", meal)
...
def choose_room():
    ...
    # Assigns and returns user's choice and cost of room
    ...
    if room_entry == 'S':
        a_room_choice = "Single Room"
        a_room_cost = 3000
    else:
        a_room_choice = "Double Room"
        a_room_cost = 2000
    return a_room_choice, a_room_cost
...
def choose_meal():
    ...
    # Display user's choice
    # Assigns and returns user's choice and cost of meals
    ...
    if meal_entry == 1:
        a_meal_choice = "21-Meal Plan"
        a_meal_cost = 3500
    else:
        a_meal_choice = "15-Meal Plan"
        a_meal_cost = 2800
    return a_meal_choice, a_meal_cost
